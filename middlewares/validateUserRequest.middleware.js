// middlewares/validateUserRequest.middleware.js
...
const isUserIdProvided = async (req, res, next) => {
    const userIdReq = req?.body?.userId || null;
...
export { isPasswordProvided, isEmailRegisteredOrProvided, isUserIdRegisteredOrProvided, isUserIdProvided };
